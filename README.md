...
I'm a Full-Stack Programmer with over 6 years of experience building dynamic applications, games, and backend systems. 

## Programming Languages
* 🌐 **Web:** JavaScript, TypeScript, HTML, CSS
* 🕹️ **Scripting & Game Dev:** Luau, Lua
* ⚙️ **Systems & Backend:** Python, Java, C

## Tools 
* 🧠 **AI & Analysis:** Claude, Gemini, Ghidra
* 🔧 **Build Tools & Version Control:** Git, GCC, Vite, Rojo
* 🏗️ **Frameworks & Runtimes:** Node.js, React, Luvit
* 💬 **Bot Development:** Discord.js, Sapphire Discord Bot Framework
